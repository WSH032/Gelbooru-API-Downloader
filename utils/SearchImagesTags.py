...
class SearchImagesTags:
    ...
    def image_files(self) -> list[str]:
        ...
        image_files_names_list = [
            ...
            if os.path.isfile(os.path.join(self.search_dir, f))
            and f.lower().endswith(self._IMAGE_EXTENSION)
        ]
    ...
    def tag_files(self) -> list[str]:
        ...
        # 将扩展名改为tags_file_ext
        tag_files_names_list = [
            self.change_ext_with_old_name(f, self.tag_files_ext)
            for f in images_names_list
        ]
